...
CUDA_VISIBLE_DEVICES=1 nohup python -u main.py --dataset cora --seed 2 > cora_2.log 2>&1 &
CUDA_VISIBLE_DEVICES=2 nohup python -u main.py --dataset usa-airports --seed 1 > usa-airports_1.log 2>&1 &
CUDA_VISIBLE_DEVICES=3 nohup python -u main.py --dataset usa-airports --seed 2 > usa-airports_2.log 2>&1 &
